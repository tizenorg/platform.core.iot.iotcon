...
int ic_utils_get_device_info(OCDeviceInfo *device_info)
{
	...
	ret = system_settings_get_value_string(SYSTEM_SETTINGS_KEY_DEVICE_NAME,
...
{
	RETM_IF(NULL == platform_info, "platform_info is NULL");
...
int ic_utils_get_platform_info(OCPlatformInfo *platform_info)
{
	...
	RETVM_IF(NULL == platform_info, IOTCON_ERROR_INVALID_PARAMETER, "platform_info is NULL");
