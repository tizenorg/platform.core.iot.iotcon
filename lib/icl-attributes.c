...
API int iotcon_attributes_get_int(iotcon_attributes_h attributes, const char *key, int *val)
{
...
API int iotcon_attributes_add_int(iotcon_attributes_h attributes, const char *key, int val)
{
	iotcon_value_h value;
...
API int iotcon_attributes_get_bool(iotcon_attributes_h attributes, const char *key, bool *val)
{
...
API int iotcon_attributes_add_bool(iotcon_attributes_h attributes, const char *key, bool val)
{
	iotcon_value_h value = NULL;
...
API int iotcon_attributes_get_double(iotcon_attributes_h attributes, const char *key, double *val)
{
	icl_basic_s *real = NULL;
	iotcon_value_h value = NULL;
...
API int iotcon_attributes_add_double(iotcon_attributes_h attributes, const char *key, double val)
{
	iotcon_value_h value = NULL;
...
API int iotcon_attributes_get_str(iotcon_attributes_h attributes, const char *key, char **val)
{
	icl_basic_s *real = NULL;
	iotcon_value_h value = NULL;
...
API int iotcon_attributes_add_str(iotcon_attributes_h attributes, const char *key, char *val)
{
	iotcon_value_h value = NULL;
...
API int iotcon_attributes_add_byte_str(iotcon_attributes_h attributes, const char *key,
		unsigned char *val, int len)
{
	iotcon_value_h value = NULL;
...
API int iotcon_attributes_is_null(iotcon_attributes_h attributes, const char *key, bool *is_null)
{
	icl_basic_s *real = NULL;
	iotcon_value_h value = NULL;
...
API int iotcon_attributes_add_attributes(iotcon_attributes_h attributes, const char *key,
...
int icl_attributes_set_value(iotcon_attributes_h attributes, const char *key, iotcon_value_h value)
{
	RETV_IF(NULL == attributes, IOTCON_ERROR_INVALID_PARAMETER);
	RETV_IF(NULL == key, IOTCON_ERROR_INVALID_PARAMETER);
...
API int iotcon_attributes_get_keys_count(iotcon_attributes_h attributes, unsigned int *count)
{
	RETV_IF(false == ic_utils_check_oic_feature_supported(), IOTCON_ERROR_NOT_SUPPORTED);
	RETV_IF(NULL == attributes, IOTCON_ERROR_INVALID_PARAMETER);
...
API int iotcon_attributes_clone(iotcon_attributes_h attributes, iotcon_attributes_h *attributes_clone)
{
	int ret;
	...
	if (attributes->hash_table) {
		...
		g_hash_table_foreach(attributes->hash_table, (GHFunc)icl_attributes_clone_foreach, temp);
	}
...
API int iotcon_attributes_foreach(iotcon_attributes_h attributes, iotcon_attributes_cb cb,
		void *user_data)
{
	GHashTableIter iter;
	gpointer key;
