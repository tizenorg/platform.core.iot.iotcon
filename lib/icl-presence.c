		...
		char **resource_type)
{
	RETV_IF(false == ic_utils_check_oic_feature_supported(), IOTCON_ERROR_NOT_SUPPORTED);
	RETVM_IF(NULL == presence, IOTCON_ERROR_INVALID_PARAMETER, "presence is NULL");
	RETVM_IF(NULL == resource_type, IOTCON_ERROR_INVALID_PARAMETER, "resource_type is NULL");
...
{
	RETV_IF(false == ic_utils_check_oic_feature_supported(), IOTCON_ERROR_NOT_SUPPORTED);
	RETVM_IF(NULL == response, IOTCON_ERROR_INVALID_PARAMETER, "presence is NULL");
	RETVM_IF(NULL == host_address, IOTCON_ERROR_INVALID_PARAMETER, "host_address is NULL");
		...
		iotcon_presence_result_e *result)
{
	RETV_IF(false == ic_utils_check_oic_feature_supported(), IOTCON_ERROR_NOT_SUPPORTED);
	RETVM_IF(NULL == response, IOTCON_ERROR_INVALID_PARAMETER, "presence is NULL");
	RETVM_IF(NULL == result, IOTCON_ERROR_INVALID_PARAMETER, "result is NULL");
		...
		iotcon_presence_trigger_e *trigger)
{
	RETV_IF(false == ic_utils_check_oic_feature_supported(), IOTCON_ERROR_NOT_SUPPORTED);
	RETVM_IF(NULL == response, IOTCON_ERROR_INVALID_PARAMETER, "presence is NULL");
	RETVM_IF(NULL == trigger, IOTCON_ERROR_INVALID_PARAMETER, "trigger is NULL");
