...
iotcon_resource_ifaces_h icl_resource_ifaces_ref(iotcon_resource_ifaces_h ifaces)
{
...
API int iotcon_resource_ifaces_create(iotcon_resource_ifaces_h *ret_ifaces)
{
...
API void iotcon_resource_ifaces_destroy(iotcon_resource_ifaces_h ifaces)
{
	RET_IF(NULL == ifaces);
...
static int _icl_resource_ifaces_strcmp(const void *a, const void *b)
{
	return strcmp(a, b);
}


static bool _icl_resource_ifaces_duplicate_check(iotcon_resource_ifaces_h ifaces,
		const char *iface)
{
	GList *node = NULL;
	...
	node = g_list_find_custom(ifaces->iface_list, iface, _icl_resource_ifaces_strcmp);
	if (NULL == node)
		return false;
...
API int iotcon_resource_ifaces_add(iotcon_resource_ifaces_h ifaces, const char *iface)
{
	char *resource_iface;
	...
	if (true == _icl_resource_ifaces_duplicate_check(ifaces, iface)) {
...
API int iotcon_resource_ifaces_remove(iotcon_resource_ifaces_h ifaces, const char *iface)
{
	GList *node;
...
API int iotcon_resource_ifaces_foreach(iotcon_resource_ifaces_h ifaces,
...
API int iotcon_resource_ifaces_clone(iotcon_resource_ifaces_h src,
...
/* counting from 0 */
const char* icl_resource_ifaces_get_nth_data(iotcon_resource_ifaces_h ifaces, int index)
{
	return g_list_nth_data(ifaces->iface_list, index);
}


unsigned int icl_resource_ifaces_get_length(iotcon_resource_ifaces_h ifaces)
{
