...
static gboolean _icl_ioty_ocprocess_find_idle_cb(gpointer p)
{
	...
	RETVM_IF(NULL == cb_data, G_SOURCE_REMOVE, "cb_data is NULL");
		...
		OCClientResponse *resp)
{
	...
	RETVM_IF(NULL == ctx, OC_STACK_KEEP_TRANSACTION, "ctx is NULL");
	RETVM_IF(NULL == resp, OC_STACK_KEEP_TRANSACTION, "resp is NULL");
		...
		OCDoHandle handle, OCClientResponse* resp)
{
	...
	RETVM_IF(NULL == ctx, OC_STACK_KEEP_TRANSACTION, "ctx is NULL");
	RETVM_IF(NULL == resp, OC_STACK_KEEP_TRANSACTION, "resp is NULL");
	RETVM_IF(NULL == resp->payload, OC_STACK_KEEP_TRANSACTION, "resp->payload is NULL");
		...
		OCDoHandle handle, OCClientResponse *resp)
{
	...
	RETVM_IF(NULL == resp, OC_STACK_KEEP_TRANSACTION, "resp is NULL");
	RETVM_IF(NULL == presence, OC_STACK_KEEP_TRANSACTION, "presence is NULL");
		...
		OCDoHandle handle, OCClientResponse *resp)
{
	...
	RETVM_IF(NULL == ctx, OC_STACK_DELETE_TRANSACTION, "ctx is NULL");
	RETVM_IF(NULL == resp, OC_STACK_DELETE_TRANSACTION, "resp is NULL");
...
static gboolean _icl_ioty_ocprocess_request_idle_cb(gpointer p)
{
	...
	RETVM_IF(NULL == req_container, IOTCON_ERROR_INVALID_PARAMETER,
			"req_container is NULL");
		...
		OCEntityHandlerRequest *request, void *user_data)
{
	...
	RETVM_IF(NULL == resource, OC_EH_ERROR, "resource is NULL");
	RETVM_IF(NULL == request, OC_EH_ERROR, "request is NULL");
