		...
		OCClientResponse *resp)
{
	...
	ret = icl_ioty_parse_oic_discovery_payload(&(resp->devAddr), (OCDiscoveryPayload*)resp->payload,
		...
		OCClientResponse *resp)
{
	...
	ret = icl_ioty_parse_oic_presence_payload(&resp->devAddr, (OCPresencePayload*)resp->payload,
