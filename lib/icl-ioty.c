...
void icl_ioty_deinit(GThread *thread)
{
	...
	RETM_IF(NULL == thread, "thread is NULL");
...
int icl_ioty_init(GThread **out_thread)
{
	...
	RETVM_IF(NULL == out_thread, IOTCON_ERROR_INVALID_PARAMETER, "out_thread is NULL");
...
static gboolean _icl_ioty_timeout(gpointer user_data)
{
	...
	RETVM_IF(NULL == cb_info, G_SOURCE_REMOVE, "cb_info is NULL");
	cb_info->timeout = 0;
...
static void _icl_ioty_free_cb_data(void *data)
{
	...
	RETM_IF(NULL == cb_info, "cb_info is NULL");
		...
		iotcon_presence_h *presence_handle)
{
	...
	RETVM_IF(NULL == cb, IOTCON_ERROR_INVALID_PARAMETER, "cb is NULL");
	RETVM_IF(NULL == presence_handle, IOTCON_ERROR_INVALID_PARAMETER,
...
static char* _icl_ioty_resource_generate_uri(char *uri_path, GHashTable *hash)
{
	...
	RETVM_IF(NULL == uri_path, NULL, "uri_path is NULL");
...
static gboolean _icl_ioty_response_timeout(gpointer p)
{
	...
	RETVM_IF(NULL == cb_container, G_SOURCE_REMOVE, "cb_container is NULL");
		...
		void *user_data)
{
	...
	RETM_IF(NULL == resource, "resource is NULL");
	RETM_IF(NULL == response, "response is NULL");
		...
		iotcon_resource_h *resource_handle)
{
	...
	RETVM_IF(NULL == uri_path, IOTCON_ERROR_INVALID_PARAMETER, "uri_path is NULL");
	RETVM_IF(ICL_URI_PATH_LENGTH_MAX < strlen(uri_path),
			IOTCON_ERROR_INVALID_PARAMETER, "Invalid uri_path(%s)", uri_path);
	RETVM_IF(NULL == res_types, IOTCON_ERROR_INVALID_PARAMETER, "res_types is NULL");
	RETVM_IF(NULL == cb, IOTCON_ERROR_INVALID_PARAMETER, "cb is NULL");
	RETVM_IF(NULL == resource_handle, IOTCON_ERROR_INVALID_PARAMETER,
			"ersource_handle is NULL");
		...
		iotcon_resource_h child)
{
	...
	RETVM_IF(NULL == parent, IOTCON_ERROR_INVALID_PARAMETER, "parent is NULL");
	RETVM_IF(NULL == child, IOTCON_ERROR_INVALID_PARAMETER, "child is NULL");
...
int icl_ioty_response_send(iotcon_response_h response_handle)
{
	...
	RETVM_IF(NULL == response_handle, IOTCON_ERROR_INVALID_PARAMETER,
			"response_handle is NULL");
...
{
	RETVM_IF(NULL == time_interval, IOTCON_ERROR_INVALID_PARAMETER,
			"time_interval is NULL");
