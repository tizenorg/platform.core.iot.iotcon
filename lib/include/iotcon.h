 ...
 * The higher @a interval, the faster the operation of iotcon.
 ...
 * @details This API invokes a next message from a queue for receiving messages from others, immediately. After calling the API, it starts polling, again.
 *
 * @since_tizen 3.0
 * @privlevel public
 * @privilege %http://tizen.org/privilege/network.get
