		...
		iotcon_remote_resource_h *resource_handle)
{
	...
	RETVM_IF(NULL == resource_types, IOTCON_ERROR_INVALID_PARAMETER,
			"resource_types is NULL");
	RETVM_IF(NULL == resource_ifaces, IOTCON_ERROR_INVALID_PARAMETER,
			"resource_ifaces is NULL");
		...
		const char *data, void *user_data)
{
	...
	RETVM_IF(NULL == resource, IOTCON_FUNC_STOP, "resource is NULL");
		...
		char **device_id)
{
	RETV_IF(false == ic_utils_check_oic_feature_supported(), IOTCON_ERROR_NOT_SUPPORTED);
	RETVM_IF(NULL == resource, IOTCON_ERROR_INVALID_PARAMETER, "resource is NULL");
	RETVM_IF(NULL == device_id, IOTCON_ERROR_INVALID_PARAMETER, "device_id is NULL");
		...
		int *properties)
{
	RETV_IF(false == ic_utils_check_oic_feature_supported(), IOTCON_ERROR_NOT_SUPPORTED);
	RETVM_IF(NULL == resource, IOTCON_ERROR_INVALID_PARAMETER, "resource is NULL");
	RETVM_IF(NULL == properties, IOTCON_ERROR_INVALID_PARAMETER, "properties is NULL");
