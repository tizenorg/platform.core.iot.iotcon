		...
		int resource_count)
{
	...
	RETM_IF(NULL == resource_list, "resource_list is NULL");
		...
		int *resource_count)
{
	...
	RETVM_IF(NULL == payload, IOTCON_ERROR_INVALID_PARAMETER, "payload is NULL");
	RETVM_IF(NULL == dev_addr, IOTCON_ERROR_INVALID_PARAMETER, "dev_addr is NULL");
	RETVM_IF(NULL == resource_list, IOTCON_ERROR_INVALID_PARAMETER, "resource_listis NULL");
	RETVM_IF(NULL == resource_count, IOTCON_ERROR_INVALID_PARAMETER,
			"resource_count is NULL");
		...
		iotcon_presence_response_h *presence_response)
{
	...
	RETVM_IF(NULL == dev_addr, IOTCON_ERROR_INVALID_PARAMETER, "dev_addr is NULL");
	RETVM_IF(NULL == payload, IOTCON_ERROR_INVALID_PARAMETER, "payload is NULL");
	RETVM_IF(NULL == presence_response, IOTCON_ERROR_INVALID_PARAMETER,
			"presence_response is NULL");
		...
		OCRepPayloadValueArray *arr, int len, int index, iotcon_list_h *list)
{
	...
	RETVM_IF(NULL == arr, IOTCON_ERROR_INVALID_PARAMETER, "arr is NULL");
		...
		struct icl_state_list_s *value_list, int depth)
{
	...
	RETVM_IF(NULL == list, IOTCON_ERROR_INVALID_PARAMETER, "list is NULL");
	RETVM_IF(NULL == value_list, IOTCON_ERROR_INVALID_PARAMETER, "value_list is NULL");
		...
		OCHeaderOption dest[], int dest_size)
{
	...
	RETVM_IF(NULL == options, IOTCON_ERROR_INVALID_PARAMETER, "options is NULL");
	RETVM_IF(NULL == options->hash, IOTCON_ERROR_INVALID_PARAMETER,
			"options->hash is NULL");
